...
export const serviceData = {
  ...
  preheatConfig: {
    service: {
      DATA_START_DEP_TIME: { command: 'preheat_start_departure_time', icon: 'mdi:cog', label: 'save' },
  ...
  batteryChargeConfig: {
    service: {
      ...
      DATA_CHARGE_PROGRAM: { command: 'charge_program_configure', icon: 'mdi:ev-station', label: 'save program' },
    },
    data: {
