...
## What's Changed
### New Features 🎉
* Introduce new properties for state color, notification icon, and transparent layout options. by [@ngocjohn](https://github.com/ngocjohn) in [#181](https://github.com/ngocjohn/vehicle-info-card/pull/181)
### Fixes 🐛
...
* Refactor for improved localization, type safety, and component structure by [@ngocjohn](https://github.com/ngocjohn) in [#344](https://github.com/ngocjohn/vehicle-info-card/pull/344)


**Full Changelog**: https://github.com/ngocjohn/vehicle-info-card/compare/v1.11.0...v1.12.1
